 ...
 */
- (void)sendVideoFrame:(char*)frameBuffer width:(int)width height:(int)height frameLength:(int)frameLength rotation:(int)rotation DEPRECATED_MSG_ATTRIBUTE("Use -sendVideoFrame: width: height: frameLength: rotation: format: instead");
