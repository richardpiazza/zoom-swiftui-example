...
/**
 ...
 @note Since cloud recording involves asynchronous operations, a return value of ZMVideoSDKErrors_Success does not guarantee that the recording will start. See {@link ZMVideoSDKDelegate onCloudRecordingStatus:} for information on how to confirm that recording has commenced.
...
/**
 ...
 @note Since cloud recording involves asynchronous operations, a return value of ZMVideoSDKErrors_Success does not guarantee that the recording will stop. See {@link ZMVideoSDKDelegate onCloudRecordingStatus:} for information on how to confirm that recording has ended.
...
/**
 ...
 @note Since cloud recording involves asynchronous operations, a return value of ZMVideoSDKErrors_Success  does not guarantee that the recording will pause. See {@link ZMVideoSDKDelegate onCloudRecordingStatus:} for information on how to confirm that recording has paused.
...
/**
 ...
 @note Since cloud recording involves asynchronous operations, a return value of ZMVideoSDKErrors_Success does not guarantee that the recording will resume. See {@link ZMVideoSDKDelegate onCloudRecordingStatus:} for information on how to confirm that recording has resumed.
