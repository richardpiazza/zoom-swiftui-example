...
/**
 @brief teamIdentifier The subject.OU value of the signing certificate. After resign the SDK, you should set the team identifier of your certificate, zoom will verify the certificate when loading.
 */
@property (copy, nonatomic, nullable) NSString *teamIdentifier DEPRECATED_MSG_ATTRIBUTE("No longer used");
...
/**
 ...
 @return If the function succeeds, the return value is the live transcription helper object. Otherwise, this function returns NULL. For more details, refer to {@link ZMVideoSDKLiveTranscriptionHelper}.
 */
